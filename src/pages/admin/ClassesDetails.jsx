...
const ClasseDetails = () => {
  ...
  const getMatiereNamesByIds = (matiereIds) => {
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <DetailRow icon={School} label="Nom de la classe" value={classe.nom} />
          <DetailRow icon={BookOpen} label="Niveau" value={classe.niveau} />
          <DetailRow icon={User} label="Enseignant Principal" value={getEnseignantName(classe.enseignantPrincipal)} />
          <DetailRow icon={Users} label="Nombre d'élèves" value={classe.nombreEleves} />
          <DetailRow icon={School} label="Salle de classe" value={classe.salle} />
        </div>
      </Card>
